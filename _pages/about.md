...
* July 2026, I served as a Session Chair for the "Advances in Computer Vision and Graphics for Structural Health Monitoring" technical session at the __9th World Conference on Structural Control and Monitoring (9WCSCM)__ in Sheffield, UK. I delivered an invited speech titled “Post-earthquake regional building damage assessment based on computer vision and point cloud algorithms”.

* May 2026, I delivered an invited speech titled “Multimodal large language model-driven agentic framework for post-earthquake building damage assessment and reporting", at the __12th Annual Conference on Earthquake Engineering__ in Tianjin, China.

* Dec 2025, I joined the Early-Career Editorial Board of the Journal of Railway Science and Technology.

* Aug 2025, I served as a Session Chair for the __3rd China-Canada Symposium on Structural & Earthquake Engineering (CCSSEE)__ in Vancouver, Canada. I delivered an invited speech about “Large language model-driven AI agents for smart inspection and construction: preliminary studies”.
  
* July 2025, I served as a Session Chair for the “CV-Enhanced SHM" technical session at the __16th International Workshop on Advanced Smart Materials and Smart Structures Technology (ANCRiSST)__ in Hong Kong SAR. I delivered an invited speech about “Computer vision-based structural damage inspection and health monitoring: recent studies”.
  
* May 2025, I served as a Session Chair for the “Computer Vision for Civil Engineering” technical session at the __3rd Annual Symposium of Big Data and Artificial Intelligence in Civil Engineering__ in Harbin, China. I delivered a keynote presentation about “Computer vision-based structural damage inspection: past, present, and future”.
...
* Aug 2024, the UBC Smart Structures Research Group secured the Mitacs Accelerate Fund titled "Smart Automated AI-Driven Digital Construction using 5G network", funded by Mitacs and Rogers Communications (the top 3 telecom company in Canada). As a Co-Applicant, I have led a team to develop computer vision and point cloud techniques for construction site monitoring.
